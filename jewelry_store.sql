...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 01, 2025 lúc 08:19 PM
...
INSERT INTO `coupons` (`id`, `code`, `discount_type`, `discount_value`, `max_discount_amount`, `min_order_amount`, `max_uses`, `used_count`, `start_date`, `end_date`, `is_active`, `created_at`) VALUES
(9, 'WWE2', 'percentage', 15.00, 500000.00, 0.00, NULL, 1, '2025-07-29', '2025-07-29', 1, '2025-07-29 10:53:25'),
(10, 'WQWQW12', 'percentage', 10.00, 700000.00, 0.00, NULL, 0, '2025-07-29', '2025-07-29', 1, '2025-07-29 10:53:39');
...
INSERT INTO `coupon_usage` (`id`, `user_id`, `coupon_code`, `used_at`, `order_id`) VALUES
(35, 2, 'WWE2', '2025-07-29 10:54:27', 34);
...
(5, 2, 6, '2025-07-28 18:31:22'),
(7, 3, 3, '2025-07-29 10:33:50'),
(8, 2, 5, '2025-07-29 10:36:43');
...
CREATE TABLE `orders` (
  ...
  `payment` enum('cod','bank') DEFAULT 'cod',
...
INSERT INTO `orders` (`id`, `user_id`, `fullname`, `phone`, `email`, `city`, `district`, `ward`, `address`, `created_at`, `status`, `total`, `note`, `payment`, `coupon`, `product_id`) VALUES
(32, 2, 'dqwewqe', '0909747514', 'qweqweq@gmail.com', '25', '228', 'Phường Phong Châu', '1231 adawa', '2025-07-29 09:39:59', 'cancelled', 30000000, ' ', 'cod', '', 6),
(33, 2, 'AAAAAA', '0909747514', 'qweqweq@gmail.com', '22', '195', 'Phường Cẩm Trung', '1231 adawa', '2025-07-29 09:43:18', 'cancelled', 30000000, ' ', 'cod', '', 6),
(34, 2, 'dqwewqe', '84909747514', 'gregregre@gmail.com', '25', '228', 'Xã Hà Lộc', 'ewqe21e', '2025-07-29 10:54:27', 'cancelled', 44500000, ' ', 'cod', 'WWE2', 12),
(35, 3, 'dqwewqe', '0909747514', 'nhocpro989@gmail.com', '4', '42', 'Xã Nam Cao', 'adwda', '2025-08-01 16:58:10', 'pending', 15000000, ' ', 'cod', '', 5);
...
INSERT INTO `products` (`id`, `name`, `type`, `price`, `stock`, `description`, `img`, `label`, `rented`, `star`, `views`) VALUES
(1, 'TINY CH CROSS WITH ONE SILVER BALL CHARM', 'daychuyen', 11000000, 10, 'This 1-ball Tiny Chrome Hearts Cross Charm is an item that reminds you of the essence of silver.\r\n\r\nThe cross charm with a gentle line peculiar to Chrome Hearts is brilliant because it is in the human chest. Silver was originally a special honor for kings and priests, and that effect can be realized through this charm.', '/test/public/uploads/img_687eb604eec54_daychuyen.png', 'NEW', 0, 5, 0),
(2, 'TINY CH CROSS WITH ONE SILVER BALL CHARM', 'daychuyen', 15000000, 4, 'Delivering an idyllic balance of classic heritage and contemporary style, this striking Chrome Hearts pendant can be used to enhance a multitude of outfits.', '/test/public/uploads/img_687eb0fee2ee7_image (1).png', 'HOT', 0, 5, 0),
(3, 'DOUBLE DAGGER PENDANT', 'daychuyen', 12000000, 3, '', '/test/public/uploads/img_687eb6b983374_daychuyen2.png', '', 0, 5, 0),
(4, 'FILIGREE CROSS CHARM', 'daychuyen', 10000000, 1, '', '/test/public/uploads/img_687eb6d06b0dd_daychuyen3.png', '', 0, 5, 0),
(5, 'DOUBLE CROSS CHARM', 'daychuyen', 15000000, 4, 'One of the newer additions to the Chrome Hearts cross series. This charm is small and delicate, yet intricate with perceptible depth to it’s lines. The attention to detail by its craftsmen is superb – it is definitely hard to find a pendant that has so many desirable design elements packed into one relatively small piece of jewelry.', '/test/public/uploads/img_687eb71e53b74_daychuyen4.png', '', 0, 5, 0),
(6, 'SMALL STAR OF DAVID PENDANT', 'daychuyen', 10000000, 7, 'This small Star of David pendant derives its name from the star of David, which is the sacred symbol of Judaism. It is a hexagonal star with silver interconnections. The Chrome Hearts lettering is engraved on the inside of the star.', '/test/public/uploads/img_687eb740a46ae_daychuyen5.png', '', 0, 5, 0),
(10, '6MM CHROME HEARTS FOREVER RING – SPACER', 'ring', 12000000, 5, 'If you’re in search of the symbol of eternal devotion, the Chrome Hearts Forever Ring – Spacer should be your go-to piece. A Chrome Hearts icon that’s guaranteed to be noticed, this Forever Chrome Hearts ring is a stunning piece you need in your collection. Mirroring the iconic style of the Cartier “Love Bracelet”, this ring is the embodiment of classic luxury.', '/test/public/uploads/img_6888a484335aa_nhan1.png', NULL, 0, 5, 0),
(11, 'CHROME HEARTS ETERNITY VINE RING', 'ring', 11000000, 5, 'The Chrome Hearts eternity vine ring is a very popular ring for weddings and engagements. The Chrome Hearts vine ring is carved with a vine motif that symbolizes the hope of love that will be intertwined forever.', '/test/public/uploads/img_6888a4aa44ea0_nhan2.png', NULL, 0, 5, 0),
(12, 'SBT BAND RING', 'ring', 15000000, 6, 'The SBT band ring is one of the most popular co-ordinating rings from Chrome Hearts. The ring has a vine-like effect running on the outside of a curved band. There are four equally spaced crosses on the ring, giving it a very strong Chrome Hearts feel.', '/test/public/uploads/img_6888a4c1caf1b_nhan3.png', NULL, 0, 5, 0),
(13, 'CHROME HEARTS NAIL RING – CROSSBALL', 'ring', 12000000, 5, 'Feel the Chrome Hearts Nail Ring – Crossball softly wrap around your finger. It’s smooth edges are reminiscent of the popular Cartier nail ring, yet what makes this Chrome Hearts nail ring special is its classic cross motif stamped onto the face of the ring. It is instantly recognizable.', '/test/public/uploads/img_6888a4db68b05_nhan4.png', NULL, 0, 5, 0),
(14, 'CHROME HEARTS CEMETERY RING', 'ring', 13000000, 5, 'The Chrome Hearts Cemetery Ring has a steely, heavyweight, and unrivaled presence. It is a ring that gives off an air of aristocracy, especially if paired with other more substantial Chrome Hearts rings such as the CHX Spinner and the Dagger.', '/test/public/uploads/img_6888a52a8332d_nhan5.png', NULL, 0, 5, 0),
(15, 'CHROME HEARTS CROSS TAIL RING', 'ring', 12000000, 5, 'When you wear a Chrome Hearts Cross Tail Ring, it were as if a fragment of a meteor fell to your fingertips. The design that combines only some of the classic cross motifs makes you feel a particularly unique presence among the many Chrome Hearts items.', '/test/public/uploads/img_6888a54090a08_nhan6.png', NULL, 0, 5, 0),
(16, 'ONYX BEAD BRACELET 8MM (4 SILVER BEADS)', 'vongtay', 13000000, 5, 'The Onyx Bead Bracelet is a masterpiece, showcasing the beautiful black beads with a silver touch. The bracelet gives exudes a rebellious glow that invigorates the wearer with a powerful confidence.', '/test/public/uploads/img_6888a5cc53303_vongtay1.png', NULL, 0, 5, 0),
(17, 'MULTI RING BRACELET', 'vongtay', 18000000, 6, 'The Multi Ring bracelet is a testament to Chrome Hearts’ craftsmanship and astounding attention to detail. As you can see, engraved onto each chain link is the brand’s name and a few signature cross motifs. This immediately gives off the impression that each piece is hand-crafted, which it is.', '/test/public/uploads/img_6888a5e986070_vongtay2.png', NULL, 0, 5, 0),
(18, 'BABYFAT RING BRACELET', 'vongtay', 22000000, 5, 'This playful bracelet rendition of the paper chain and cross motif comes across as both effortless and luxurious while at the same time preserving the youthful rock n’ roll vibe synonymous with Chrome Hearts products.', '/test/public/uploads/img_6888a60ec5baa_vongtay3.png', NULL, 0, 5, 0),
(19, 'CH PLUS BRACELET', 'vongtay', 15000000, 5, 'The Chrome Hearts aesthetic and rebellious feeling is captured superbly with this plus bracelet. The soft but firm flowing motion of this bracelet gives the wearer a sense of sophistication and free-flowing luxury.', '/test/public/uploads/img_6888a626a62d3_vongtay4.png', NULL, 0, 5, 0),
(20, 'DICE AND CROSSBALL BRACELET', 'vongtay', 12000000, 5, 'The Dice and Crossball bracelet has been a Chrome Hearts favorite since inception. The attention to detail put into designing this piece is defining of what Chrome Hearts represents as a brand – classic, timeless, and artisanal.', '/test/public/uploads/img_6888a63fb5dec_vongtay5.png', NULL, 0, 5, 0),
(21, 'CH PLUS BRACELET WITH LINKS', 'vongtay', 17000000, 6, 'This plus bracelet with links epitomizes timeless Chrome Hearts design. This version of the plus bracelet exudes feelings of carefree rebellion that’s synonymous with the Chrome Hearts brand.', '/test/public/uploads/img_6888a65d5fda2_vongtay6.png', NULL, 0, 5, 0),
(22, 'CROSS CUT OUT STUD EARRING', 'bongtai', 12000000, 5, 'The Cross Babyfat Drop Earrings are as iconic as their name. Hailed as one of the all-time greats to emerge from Chrome Hearts, their striking look has turned many heads over the years – and been proudly worn by some of today’s top celebrities including Rihanna, Lady Gaga, and Bella Hadid.', '/test/public/uploads/img_6888a6ed550a4_bongtai1.png', NULL, 0, 5, 0),
(23, 'CROSS BABYFAT DROP EARRINGS', 'bongtai', 15000000, 5, 'The Cross Cut Out Stud Earrings showcase the Chrome Hearts cross motif. Its homage to classic Chrome Hearts design makes it timeless and immediately recognizable to anyone, anywhere.', '/test/public/uploads/img_6888a7076d2b3_bongtai2.png', NULL, 0, 5, 0),
(25, 'CH CROSS BABY FAT STUD EARRINGS WITH PAVÉ DIAMOND AND PAVÉ DIAMOND CUFF', 'bongtai', 18000000, 6, 'Who says that spiritual jewelry can’t be a little bit sensual? These Cross Baby Fat Earrings With Pavé Diamonds blur the lines between the sublime and the seductive.', '/test/public/uploads/img_6888a73d1f51e_bongtai4.png', NULL, 0, 5, 0),
(26, 'CH PLUS STUD EARRINGS WITH DIAMONDS', 'bongtai', 16000000, 6, 'It’s no wonder that celebrities have been star struck with Chrome Hearts that they’re often seen sporting studs such as these Chrome Hearts Plus Stud Earrings With Diamonds.', '/test/public/uploads/img_6888a759204ea_bongtai5.png', NULL, 0, 5, 0),
(27, '3 DROP CROSS EARRING', 'bongtai', 22000000, 5, 'Pierced earrings with a swinging classic Chrome Hearts cross motif, unmistakably a Chrome Hearts piece from afar. Look elegant yet devil-may-care from any angle. Sway through the streets as these beautiful silver earrings sway in brilliant appearance that shine right off your ears. These long and thin earrings make your face look sharp and immaculately accessorized.', '/test/public/uploads/img_6888a7701cd94_bongtai6.png', NULL, 0, 5, 0),
(28, 'CROSS BABYFAT DROP EARRINGS	', 'bongtai', 15000000, 6, '', '/test/public/uploads/img_6888a7bcb196c_bongtai3.png', NULL, 0, 5, 0);
...
INSERT INTO `reviews` (`id`, `user_id`, `product_id`, `order_id`, `rating`, `comment`, `admin_reply`, `images`, `is_verified`, `status`, `created_at`, `updated_at`) VALUES
(4, 2, 15, NULL, 5, 'oke', NULL, '[]', 0, 'approved', '2025-08-01 17:03:35', '2025-08-01 17:03:35');
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `role`, `created_at`, `active`) VALUES
(2, 'admin', '$2y$10$U0pqk8LHc3dcLK7vxWViye1iQYcmY8B8NwL4bsQUWVDG0HDlWVOci', 'evilofwolf@gmail.com', 'admin', '2025-07-21 20:15:56', 1),
(3, 'nguyenduy98', '$2y$10$k7WKC546X7ttcvkn5JHxgO7hGy5u5OhObKX7A4nvkbmbaYkxINcrG', 'evilofwolf989@gmail.com', 'user', '2025-07-22 06:20:37', 1),
(4, 'nguyenduy1', '$2y$10$XdoXc2JFrsqUKyLKLuCEneviX5yfbJUCroTUD1NuDfHmyyuSyPxJW', 'nhocpro989@gmail.com', 'user', '2025-07-27 20:00:05', 1);
...
ALTER TABLE `coupon_usage`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_coupon_unique` (`user_id`,`coupon_code`),
...
ALTER TABLE `coupon_usage`
  ...
  ADD CONSTRAINT `coupon_usage_ibfk_2` FOREIGN KEY (`coupon_code`) REFERENCES `coupons` (`code`) ON DELETE CASCADE;
